...
class SiteController extends Controller
{
    ...
    public function actionStart()
    {
        ...
        if (count($questions) == 0) {
            throw new NotFoundHttpException(Yii::t('app', "The quiz didn't have any question yet."));
        }
        ...
        if (self::MINIMUM_SCORE !== false && $score >= self::MINIMUM_SCORE) {
            ...
            if (isset($_POST['DiplomaForm'])) {
                ...
                if ($diplomaForm->validate()) {
                    require __DIR__ . '/../lib/fpdf181/fpdf.php';
                    ...
                    $pdf->Ln();
                    $category = QuizCategory::find()->where(array('id' => Yii::$app->session['category']))
                        ->one();
